...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("globalAmbientColor", .05, .05, .06);

	m_pShaderManager->setVec3Value("lightSources[0].position", -3.0f, 10.0f, 8.0f);
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 3.0f, 4.0f, 8.0f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 0.5f, 0.6f, 0.9f);
...
void SceneManager::PrepareScene()
{
	...
	//To Load and render Textures
	LoadSceneTextures();
	//define materials for the objects in the scene
	DefineObjectMaterials();
	// add lights to the scene
	SetupSceneLights();

	/**************************************************/
	//Additional load meshes for the shapes being used//
	/**************************************************/
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(1.7f, 0.3f, 5.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(2.0f, 0.3f, 5.5f);
...
3
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.3f, 0.3f, 5.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.6f, 0.3f, 5.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-2.8f, 0.3f, 5.5f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(16.0f, 0.7f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.4f, 0.4f, -4.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(16.0f, 0.6f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.4f, 4.4f, -4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-0.4f, 8.4f, -4.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(8.0f, 0.6f, 4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(7.3f, 4.3f, -4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-8.1f, 4.3f, -4.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-5.0f, 3.6f, 2.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.5f, 0.4f, 1.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(4.5f, 0.4f, 2.0f);
	...
	/*********************************/
	//Wooden Plank Rounded edge right
	/********************************/

	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.22f, 4.5f, 0.3f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(6.79f, 0.4f, 2.6f);
	...
	/*********************************/
	//Wooden Plank Rounded edge Left
	/********************************/
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(6.79f, 0.4f, 1.4f);
