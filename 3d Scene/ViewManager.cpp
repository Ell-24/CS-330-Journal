...
/************************************/
//Mouse scroll camera speed control
/***********************************/
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	/**************************************************/
	//Function added to add up and down camera movement
	//q is up e is down
	/**************************************************/
	...
	/**************************************************/
	//Function added for orthrographic and perspective camera set
	//o is orthrographic, p is perspective
	/**************************************************/
	
	// Press O for orthrographic view
	if (glfwGetKey(m_pWindow, GLFW_KEY_O) == GLFW_PRESS)
	{
		// orthographic projection
		bOrthographicProjection = true;
		// change the camera settings to show a front orthographic view
		g_pCamera->Position = glm::vec3(0.0f, 4.0f, 13.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
	...
	if (glfwGetKey(m_pWindow, GLFW_KEY_P) == GLFW_PRESS)
	{
		...
		g_pCamera->Position = glm::vec3(0.0f, 5.5f, 14.0f);
		g_pCamera->Front = glm::vec3(0.0f, -0.7f, -2.0f);
		g_pCamera->Up = glm::vec3(0.0f, 1.0f, 0.0f);
		g_pCamera->Zoom = 80;
}
...
void ViewManager::PrepareSceneView()
{
	...
	else
	{
		...
		if (WINDOW_WIDTH > WINDOW_HEIGHT)
		{
			...
			projection = glm::ortho(-5.0f, 5.0f, -5.0f * (float)scale, 7.0f * (float)scale, 0.1f, 100.0f);
		}
